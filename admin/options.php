    ...
    <div id="poststuff">
        ...
        <div class="right-column">
            ...
            <div class="postbox" id="new">
                <h3 class="hndle"><span>New in 1.0.5</span></h3>
                <div class="inside">
                    <p>Firstly I would like to say a big thank you to everyone for their support behind wp3i. Version 1.0.5 features some great improvements which I'm sure your going to enjoy.</p>
                    <ul>
